...
namespace GoatForms
{
    public partial class ControlFactory
    {
        ...
        /// If the parent control is <see langword="null"/>, an <see cref="ArgumentNullException"/> will be thrown. 
        /// </remarks>
        public static ListBox AddListBoxToTabPage(TabPage tabPage, string description = null, ContextMenuStrip contextMenu = null, EventHandler onSelectedIndexChanged = null, bool styledControl = false)
        {
            if (tabPage == null)
            {
                throw new ArgumentNullException(nameof(tabPage));
