...
namespace GoatForms
{
    public partial class ControlFactory
    {
        ...
        /// If the parent control is <see langword="null"/>, an <see cref="ArgumentNullException"/> will be thrown. 
        /// </remarks>
        public static ListBox AddListBoxToPanel(Panel panel, string description = null, bool styledControl = false)
        {
            if (panel == null)
            {
                throw new ArgumentNullException(nameof(panel));
        ...
        /// If the parent control is <see langword="null"/>, an <see cref="ArgumentNullException"/> will be thrown. 
        /// </remarks>
        public static CheckedListBox AddCheckedListBoxToPanel(Panel panel, string description = null, bool styledControl = false)
        {
            if (panel == null)
            {
                throw new ArgumentNullException(nameof(panel));
        ...
        /// <summary>
        /// Creates and adds a <see cref="StatusBar"/> control to the specified panel.
        /// </summary>
        /// <param name="panel">The parent panel to which the <see cref="StatusBar"/> will be added.</param>
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="panel"/> is <see langword="null"/>.</exception>
        /// <remarks>
        /// This method creates a <see cref="StatusBar"/> control with the specified properties and adds it to the specified panel. 
        /// If the parent control is <see langword="null"/>, an <see cref="ArgumentNullException"/> will be thrown. 
        /// </remarks>
        public static StatusBar AddStatusBarToPanel(Panel panel, string text = "", string name = null, string description = null, bool styledControl = false)
        {
            if (panel == null)
            {
                throw new ArgumentNullException(nameof(panel));
